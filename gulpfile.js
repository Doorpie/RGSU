...
let path = {
	build: {
		...
		svg: project_name + "/img/icons/sprite"
	},
	src: {
		...
		images: [src_folder + "/img/**/*.{jpg,png,gif,ico,webp}", "!**/favicon.*"],
		svg: [src_folder + "/img/icons/**/*.svg", "!**/sprite.svg"],
	...
	watch: {
		...
		images: src_folder + "/img/**/*.{jpg,png,gif,ico,webp}",
		svg: src_folder + "/img/icons/*.svg"
	},
	clean: "./" + project_name + "/"
};
...
function svg() {
	return src(path.src.svg)
		...
		.pipe(gulp.dest('./' + src_folder + '/img/icons/sprite/'))
...
let build = gulp.series(clean, fonts_otf, gulp.parallel(html, css, js, favicon, images, svg), fonts, gulp.parallel(fontstyle));
